...
_PMF的提法_：Product / Market fit means being in a good market with a product that can satisfy that market。他用5个关键要素定义PMF的问题。在这个层级模型中，每个要素就是金字塔的一层，并且直接与它上下层相关联。从下到上，这5层依次是: 
