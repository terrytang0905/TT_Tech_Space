...
_**核心思考：云计算服务本身是一种源于互联网且用于效率变革的商业模式。**_
...
1. **Data Fabric的定义**：数据织物是一种新兴的数据管理设计，它能够实现跨异构数据源的增强数据集成和共享。它不仅仅是一个单一的工具或技术，而是一个利用知识图谱、语义和活跃元数据上的机器学习/人工智能来支持更快的数据访问和共享的集成层。
...
公共云Business Model: 面向通用行业的资源按量付费的共享云产品服务
...
### VI.KeyStep: 关键步骤-克服困难、实现未来云计算的PMF
...
每个障碍都会阻止一些人迁移到你的产品上。反过来看，只要你消除一个障碍，你的销售额就会翻番。包括迁移/服务/效率等等

#### 6.4.从产品商业化到市场普遍认可

产品商业化从0到1，如何实现市场的普遍认可是个很大的话题。作为一个新产品的落地，需要解析并排除障碍，当障碍解决之后，市场就会逐步放大大众的产品认可。
...
2.[折扣]必须购买 Excel —— 为前 123 个用户转换到 Excel 提供特别折扣
...
6.[交互]他们必须学习新界面 —— 让 Excel 兼容 123 的操作方式7.他们需要一台 速度更快地电脑 —— 让摩尔定律来解决
...
多数人其实并不愿意将精力花在导出与兼容上，而是希望能把潜在用户留在产品内。但**成熟的战略方法不是强迫潜在用户接受，而是在你弱小的时候，通过兼容巨头的功能，消除迁移障碍**。
...
首先，云计算是软硬一体的IT服务化的创新商业生意，是一种XaaS的商业模型的创新。Cloud Computing
