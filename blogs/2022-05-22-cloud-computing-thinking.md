...
## Cloud Computing&Data Business Thinking 2022

### I. Defination: Cloud Computing Internel-什么是云计算
...
Why is Cloud Computing poised to take off now, whereas previous attempts have foundered?
	为什么云计算现在腾飞了，而之前的尝试却失败了？ --IT基础设施成为企业科技费用的核心部分
...
What are the top 10 obstacles to the success of Cloud Computing—and the corresponding top 10 opportunities available for overcoming the obstacles?
	...
	1.高可用 / 2.Data Lock-In / 3.数据隐私与数据审计 / 4.数据传输瓶颈 / 5.性能不可预测性 / 6.可弹性计算存储 / 7.分布式系统的稳定性 / 8.极致弹性扩缩容 / 9.信誉守护服务 / 10.付费模式的进阶
...
未来应用软件、IaaS基础设施软件和硬件的设计应该做出哪些改变，以匹配云计算的需求和机遇？
	...
	1. 高可用: Redundancy for availability, so that a single machine failure doesn’t take down the service. 
	2. 跨地域分布容灾: Geographic distribution of redundant copies to preserve the service in case of disaster.
	3. 负载均衡&软路由: Load balancing and request routing to efficiently utilize resources.
	4. 弹性伸缩: Autoscaling in response to changes in load to scale up or down the system.
	5. 监控高性能运行: Monitoring to make sure the service is still running well.
	6. 日志管理&性能调优: Logging to record messages needed for debugging or performance tuning. 
	7. 系统升级&安全补丁: System upgrades, including security patching.
	8. 动态Instance漂移: Migration to new instances as they become available.
...
行业资深人士的同一个观点，国际云厂商依旧沿着公有云规模扩张、成本降低，上层SaaS应用带动用云量增长的预定轨迹前进。国际云厂商和中国云厂商间的规模差距、技术差距正在被拉大。双方已走到分岔的十字路口，未来差距可能还将被进一步拉大。

		Tips: 云计算的营收主要来自IaaS云基础产品,PaaS层云产品要么依赖云端IaaS层产品来强化其云计算能力,要么统一按照全托管产品形态来输出。

**亚马逊AWS**在公有云市场具有绝对优势，产品包括云、数据库等，但PaaS、SaaS层较单薄，主要依靠SAP、Salesforce等平台层合作伙伴补足。亚马逊AWS还被认为在垂直行业缺少积淀。
...
过去，亚马逊AWS的客户包括Facebook、Instagram、Netflix等知互联网产品或企业。不过，2021年亚马逊AWS在**金融、医疗、制造、政府、电信**等大型行业客户市场取得了较大突破。
	  ...
	  Tips:阿里云当前在金融/制造/政府领域有较大突破,运营商/医疗行业依然有待发力。

![云厂商行业头部客户](_includes/市场-云厂商行业头部客户.png)

**微软云**（智能云+生产力与业务流程）2021年总营收为800亿美元。微软云规模不输与亚马逊AWS是三方面因素决定的。一是业务布局，二是客户关系，三是行业积淀。

从**业务布局**的角度看，微软从传统IT和传统软件阶段开始，用数十年构建了一条完整的To B产业链，具备公有云、混合云、私有云，集成、咨询及服务能力。微软还在PaaS和SaaS层形成了“Teams+Office365+Dynamic+Power Platform+Linkedin”的完整应用布局。
...
大型政府、企业客户通常看重**公有云、私有云、混合云以及集成、咨询及服务能力**，微软、IBM等企业在该市场的优势强于亚马逊AWS。微软当前的产品、业务、战略布局看起来几乎没有短板。

		Tips:华为云的打法类似微软,依赖于其多年的ToB行业积淀与成熟的渠道生态打法,在很多非互联网相关行业包括运营商、金融、政府、制造等领域,即使产品能力一般,在国内依然有较大优势。

#### 2.2.Cost: 云计算厂商的盈亏平衡点
...
云厂商提高利润率通常可以通过四种途径。
	...
	三是控制集成项目和定制项目的规模；伙伴优先
	四是延长服务器、网络等硬件设备的使用寿命。

亚马逊是全球第一大云厂商，靠规模摊薄硬件成本效应明显。亚马逊AWS通常只提供标准化服务，**不承接集成项目和定制化项目的开发**。

		Tips: 与PaaS产品相关的主要是二/三点。第二点,PaaS产品的标准化与差异化优势非常重要。产品定价需要按照市场竞争关系来定义,而非从自身产品成本来考量。第三点,混合云项目中集成与定制类需求非常多,其依赖于人力资源成本,明显影响最终项目的营收情况。亚马逊在成熟软件市场是可以拒绝集成项目和定制化项目,但在中国不成熟市场无法避免,那么如何解决？

微软智能云的经营利润率比亚马逊AWS高14%，核心原因是，**微软高附加值的软件产品占比大。此外微软可以把现有客户转化为微软云客户**，不同于亚马逊AWS要组建新团队“打新单”，微软成本更低。

		Tip: 专业大数据产品团队需要优先在于完善产品关键能力与关注存量客户留存率/续约率/Upsell,而不是还未产品还没成熟的情况下,不断的'打新单',特别是混合云大客户。

#### 2.3.公共云与混合云的核心差异到底在哪里？

技术改变商业模式的典范-VMWare。云计算也算是技术+商业模式变革的典范, 但在绝大多数情况找到一个清晰有效的市场比什么都更有价值。
...
云计算公共云的典型特征：
	...
	3.按需部署与按量(时间+资源)付费
	4.可靠性高&高可用 
	5.性价比ROI高 / Business Model: Pay as you go
	6.架构的多路复用
...
_**混合云/私有云/行业云是不是值得投入**_

由于国内非互联网客户对软件产品的理解不成熟, 导致云厂商需要为客户部署私有云、混合云，并更多扮演集成商角色，面临更分散、个性的市场需求。这些需求标准化程度低，难以简单复用。经营成本远高于海外云厂商。事实上, 中国市场和国际市场需求截然不同，双方原本就是两个土壤、两种需求。从多年的数据智能行业的市场探索, 笔者的判断在未来的很长一段时间, 在中国的商业土壤上, 混合云/私有云/行业云等多种非公有云的云产品形态将在非互联网行业普遍存在且存在较多商业营收机会。基于最初公有云设想的“水电煤”自助服务，在中国市场变成了贴身服务, 无论是公共云与混合云。其背后的问题原因很多。
...
### III.Value: 数据AI产品商业化的价值呈现，未来在哪里？
...
**聚焦到了6个方面：政府央企、金融服务、智能制造业(汽车/半导体)、零售和消费科技、媒体和娱乐(游戏)、以及海外全球化。**

**A1.政府行业-数据业务特征分析**
大安全+政务服务&城市大脑
![数字行业分析1-数字政府](_includes/数字行业分析1-数字政府.png)

**A2.集团企业行业-数据业务特征分析**
核心关注运营商/能源/电力
![数字行业分析2-能源电力](_includes/数字行业分析2-能源电力.png)
新能源
![数字行业分析2-新能源](_includes/数字行业分析2-新能源.png)

**B.金融服务行业-数据业务特征分析**
金融服务数字化转型+基础PaaS产品的国产化信创
![数字行业分析3-金融服务](_includes/数字行业分析3-金融服务.png)

**C.智能制造(汽车/半导体)行业-数据业务特征**
![数字行业分析4-汽车自动驾驶](_includes/数字行业分析4-汽车自动驾驶.png)

**D.零售&消费科技行业-数据业务特征**
消费科技-出海/物联网
传统零售-数据中台
![数字行业分析5-零售&消费科技](_includes/数字行业分析5-零售&消费科技.png)

**E.媒体和娱乐(游戏)行业-数据业务特征**
互联网广告&电商+游戏变现: 小红书/B站/米哈游/心动网络
![数字行业分析6-媒体&娱乐](_includes/数字行业分析6-媒体&娱乐.png)
...
ServerlessDB无服务器化数据库的挑战：

	- 没有内置的持久化存储
	- 面向连接的协议的C/S架构
	- 不支持共享内存

为什么PolarDB云端数据库的ServerlessDB很有特色

MaxCompute Serverless DataWarehouse 
...
#### 4.4.2.实时数仓:实时数据湖&数据优化格式

#### 4.4.3.**[DataArch: from DataLake to DataMesh](2022-04-02-from-datalake-to-data-mesh.md)**
...
#### 4.5.多云协同计算Multi-Cloud

	* 多云Snowflake / BigQuery-Onmi / Confluent
	* 跨云数据共享方案
...
A.Serverless Product -> 用户体验&交互性

	MaxCompute & Hologres
	
	PAI

B.Semi-Serverless Product 

	OpenSource: EMR / Flink / Dataflow 

C.研发效能: CICD / MLOps / DataOps
